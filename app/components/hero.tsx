...
function Hero() {
    return (
        <div className="fixed z-0 h-screen w-full flex flex-col justify-end items-end overflow-y-hidden">
            ...
            style={{ backgroundImage: `url('${pan.src}')` }} className='absolute z-0 bg-contain bg-no-repeat bg-center h-3/4 w-2/4'></motion.div>

            <div className='h-full w-full bg-transparent flex flex-col justify-center items-start px-[5%]'>
                <motion.div
                ...
                <motion.div
                    ...
                    className='relative z-10 tracking-tighter text-2xl font-medium mt-10'>
