    ...
    return (
        <div className="relative z-10 h-full bg-tan w-full flex flex-col justify-start items-center">
            ...
            <motion.div
                ...
                <div style={{ backgroundImage: `url('${peter2.src}')` }} className="bg-cover bg-center flex-none flex-col justify-center items-center h-96 w-full md:h-[500px] md:w-[500px]"></div>
                <div className="flex flex-col h-full md:h-[500px] justify-center w-full items-end p-5">
                    ...
                    <div className="text-xl md:text-3xl font-regular text-right mt-5">
                        <AnimatedNumbers
                            animateToNumber={420690000000000}
                            includeComma={true}
                            fontStyle={{ fontSize: 30, fontWeight: "bold" }}
                            configs={(number, index) => {
                                return { mass: 1, tension: 230 , friction: 100 };
                            }} />
